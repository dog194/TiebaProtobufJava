...
public final class ImShareThreadInfo extends Message {
    ...
    public static final class Builder extends Message.Builder<ImShareThreadInfo> {
        ...
        public Builder(ImShareThreadInfo imShareThreadInfo) {
            ...
            this.agree = imShareThreadInfo.agree;
            this.replyNum = imShareThreadInfo.replyNum;
            this.agreeNum = imShareThreadInfo.agreeNum;
            this.shareNum = imShareThreadInfo.shareNum;
        }
    ...
    public ImShareThreadInfo(Builder builder, boolean z) {
        ...
        if (z) {
            ...
            Integer num3 = builder.replyNum;
            if (num3 == null) {
                this.replyNum = DEFAULT_REPLYNUM;
            } else {
                this.replyNum = num3;
            }
            Integer num4 = builder.agreeNum;
            if (num4 == null) {
                this.agreeNum = DEFAULT_AGREENUM;
            } else {
                this.agreeNum = num4;
            }
            Integer num5 = builder.shareNum;
            if (num5 == null) {
                this.shareNum = DEFAULT_SHARENUM;
                return;
            } else {
                this.shareNum = num5;
                return;
